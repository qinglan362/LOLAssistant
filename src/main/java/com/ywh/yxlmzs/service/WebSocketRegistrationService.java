...
// 设置会话空闲超时时间（以毫秒为单位）设置为24小时
        ...
        clientWebSocket = new ClientWebSocket(getGlobalTokenAndPort,pickChampionId,banChampionId,autoContinueNextGame,autoAccecptMatch,autoSearchMatch,autoSwap,sendTeamMatch);
